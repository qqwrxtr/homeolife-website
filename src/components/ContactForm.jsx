          ...
          <div className="flex flex-col lg:flex-row gap-12 lg:gap-16">
            ...
            <div className="lg:w-2/5">
              <div className="bg-slate-50 p-8 rounded-lg border border-slate-200 h-full">
                ...
                {/* Call to Action */}
                <div className="mt-4 pt-6 border-t border-slate-200 text-start">
                  <p className="text-slate-700 mb-4">
                    {t('contact.cta')}
                  </p>
                  <a 
                    href="tel:+380996668866" 
                    className="inline-flex items-center bg-teal-600 hover:bg-teal-700 text-white font-medium py-2 px-4 rounded-md shadow-md transition-all duration-300 hover:shadow-lg"
                  >
