            ...
            <div className="w-full max-w-[90vw] mx-auto">
              ...
              <div className="flex flex-wrap items-center gap-2 sm:gap-4 text-xs sm:text-sm text-white/90 mb-2 sm:mb-4">
                <span className="flex items-center">
                  ...
                  {t("usefullInfo.blog_1.author")}
                </span>
                <span className="flex items-center">
                  <svg xmlns="http://www.w3.org/2000/svg" className="h-3 w-3 sm:h-4 sm:w-4 mr-1" viewBox="0 0 20 20" fill="currentColor">
                    <path fillRule="evenodd" d="M6 2a1 1 0 00-1 1v1H4a2 2 0 00-2 2v10a2 2 0 002 2h12a2 2 0 002-2V6a2 2 0 00-2-2h-1V3a1 1 0 10-2 0v1H7V3a1 1 0 00-1-1zm0 5a1 1 0 000 2h8a1 1 0 100-2H6z" clipRule="evenodd" />
                  </svg>
                  {formatDate(t("usefullInfo.blog_1.date_published"))}
                </span>
                <span className="flex items-center">
                  <svg xmlns="http://www.w3.org/2000/svg" className="h-3 w-3 sm:h-4 sm:w-4 mr-1" viewBox="0 0 20 20" fill="currentColor">
              ...
              <div className="prose prose-lg prose-teal max-w-none">
                ...
                <div className="bg-white rounded-lg sm:rounded-xl shadow-sm border border-slate-200 p-4 sm:p-6 md:p-8 mb-6 sm:mb-8">
                  <h2 className="text-lg sm:text-xl md:text-2xl font-bold text-slate-800 mb-3 sm:mb-5" id="section-1">
                    {t("usefullInfo.blog_1.sections.0.title")}
                  </h2>
                  <p className="mb-4 sm:mb-5 text-sm sm:text-base text-slate-700 leading-relaxed">{t("usefullInfo.blog_1.sections.0.content")}</p>
                    ...
                    <ul className="space-y-2 sm:space-y-3">
                      {[0, 1, 2, 3].map((index) => (
                        <li key={index} className="flex items-start">
                          ...
                          <span className="text-sm sm:text-base text-slate-700">{t(`usefullInfo.blog_1.sections.0.list.${index}`)}</span>
                        </li>
                      ))}
                    </ul>
                  </div>
                  
                  <p className="italic text-sm sm:text-base text-slate-600 border-l-4 border-teal-500 pl-3 sm:pl-4 py-1 sm:py-2">{t("usefullInfo.blog_1.sections.0.conclusion")}</p>
                </div>
                
                {/* Section 2 */}
                <div className="bg-white rounded-lg sm:rounded-xl shadow-sm border border-slate-200 p-4 sm:p-6 md:p-8 mb-6 sm:mb-8">
                  <h2 className="text-lg sm:text-xl md:text-2xl font-bold text-slate-800 mb-3 sm:mb-5" id="section-2">
                    {t("usefullInfo.blog_1.sections.1.title")}
                  </h2>
                  <p className="text-sm sm:text-base text-slate-700 leading-relaxed">{t("usefullInfo.blog_1.sections.1.content")}</p>
                </div>
                
                {/* Section 3 */}
                <div className="bg-white rounded-lg sm:rounded-xl shadow-sm border border-slate-200 p-4 sm:p-6 md:p-8 mb-6 sm:mb-8">
                  <h2 className="text-lg sm:text-xl md:text-2xl font-bold text-slate-800 mb-3 sm:mb-5" id="section-3">
                    {t("usefullInfo.blog_1.sections.2.title")}
                  </h2>
                  <p className="mb-4 sm:mb-5 text-sm sm:text-base text-slate-700 leading-relaxed">{t("usefullInfo.blog_1.sections.2.content")}</p>
                    ...
                    <ul className="space-y-2 sm:space-y-3">
                      {[0, 1, 2].map((index) => (
                        <li key={index} className="flex items-start">
                          ...
                          <span className="text-sm sm:text-base text-slate-700">{t(`usefullInfo.blog_1.sections.2.list.${index}`)}</span>
                        </li>
                      ))}
                    </ul>
                  </div>
                  
                  <p className="italic text-sm sm:text-base text-slate-600 border-l-4 border-teal-500 pl-3 sm:pl-4 py-1 sm:py-2">{t("usefullInfo.blog_1.sections.2.conclusion")}</p>
                </div>
                
                {/* Section 4 */}
                <div className="bg-white rounded-lg sm:rounded-xl shadow-sm border border-slate-200 p-4 sm:p-6 md:p-8 mb-6 sm:mb-8">
                  <h2 className="text-lg sm:text-xl md:text-2xl font-bold text-slate-800 mb-3 sm:mb-5" id="section-4">
                    {t("usefullInfo.blog_1.sections.3.title")}
                  </h2>
                  <p className="mb-4 sm:mb-5 text-sm sm:text-base text-slate-700 leading-relaxed">{t("usefullInfo.blog_1.sections.3.content")}</p>
                    ...
                    <ul className="space-y-2 sm:space-y-3">
                      {[0, 1, 2, 3, 4].map((index) => (
                        <li key={index} className="flex items-start">
                          ...
                          <span className="text-sm sm:text-base text-slate-700">{t(`usefullInfo.blog_1.sections.3.list.${index}`)}</span>
                        </li>
                      ))}
                    </ul>
                  </div>
                  
                  <p className="italic text-sm sm:text-base text-slate-600 border-l-4 border-teal-500 pl-3 sm:pl-4 py-1 sm:py-2">{t("usefullInfo.blog_1.sections.3.conclusion")}</p>
                </div>
                ...
                <div className="bg-white rounded-lg sm:rounded-xl shadow-sm border border-slate-200 p-4 sm:p-6 md:p-8 mb-6 sm:mb-8" id="section-5">
                  <h2 className="text-lg sm:text-xl md:text-2xl font-bold text-slate-800 mb-3 sm:mb-5">
                    {t("usefullInfo.blog_1.conclusion.title")}
                  </h2>
                  <p className="mb-4 sm:mb-5 text-sm sm:text-base text-slate-700 leading-relaxed">{t("usefullInfo.blog_1.conclusion.intro")}</p>
                  
                  <div className="bg-teal-50 p-3 sm:p-5 rounded-lg border border-teal-100 mb-0">
                    <ul className="space-y-2 sm:space-y-3">
                      {[0, 1, 2, 3, 4].map((index) => (
                        <li key={index} className="flex items-start">
                          <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 text-teal-500 mr-2 sm:mr-3 mt-0.5 flex-shrink-0" viewBox="0 0 20 20" fill="currentColor">
                          ...
                          <span className="text-sm sm:text-base text-teal-700">{t(`usefullInfo.blog_1.conclusion.list.${index}`)}</span>
                        </li>
                      ))}
                    </ul>
                  </div>
                ...
                <div className="bg-white rounded-lg sm:rounded-xl shadow-sm border border-slate-200 p-4 sm:p-6 md:p-8 mb-6 sm:mb-8" id="section-6">
                  <p className="text-sm sm:text-base md:text-lg text-slate-700 italic leading-relaxed">{t("usefullInfo.blog_1.final_note")}</p>
                </div>
                ...
                <div className="bg-teal-50 border-2 border-teal-100 p-4 sm:p-6 md:p-8 rounded-lg sm:rounded-xl mb-6 sm:mb-8 relative mt-12 sm:mt-16">
                  ...
                  <p className="text-base sm:text-lg text-center text-slate-800 mb-4 sm:mb-6 mt-2 sm:mt-4">Остались вопросы? Хотите узнать больше о гомеопатии?</p>
              ...
              <div className="sticky top-24 space-y-4 sm:space-y-6 lg:space-y-8">
                ...
                <div className="bg-white rounded-lg sm:rounded-xl shadow-sm border border-slate-200 p-4 sm:p-6">
                  <div className="flex items-center mb-3 sm:mb-4">
                    <div className="w-12 h-12 sm:w-16 sm:h-16 bg-teal-100 rounded-full flex items-center justify-center text-teal-700 font-bold text-lg sm:text-xl mr-3 sm:mr-4 flex-shrink-0">
                      {t("usefullInfo.blog_1.author").split(' ').map(name => name[0]).join('')}
                    </div>
                    <div>
                      <h3 className="text-base sm:text-lg font-bold text-slate-800">{t("usefullInfo.blog_1.author")}</h3>
                ...
                <div className="bg-white rounded-lg sm:rounded-xl shadow-sm border border-slate-200 p-4 sm:p-6">
                  ...
                  <div className="flex flex-wrap gap-1.5 sm:gap-2">
                    {t("usefullInfo.blog_1.seo.keywords", { returnObjects: true }).map((keyword, index) => (
