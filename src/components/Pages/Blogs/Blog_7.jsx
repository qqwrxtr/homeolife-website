            ...
            <div className="w-full max-w-[90vw] mx-auto">
              ...
              <div className="flex flex-wrap items-center gap-2 sm:gap-4 text-xs sm:text-sm text-white/90 mb-2 sm:mb-4">
                <span className="flex items-center">
                  ...
                  {t("usefullInfo.blog_7.author")}
                </span>
                <span className="flex items-center">
                  <svg xmlns="http://www.w3.org/2000/svg" className="h-3 w-3 sm:h-4 sm:w-4 mr-1" viewBox="0 0 20 20" fill="currentColor">
                    <path fillRule="evenodd" d="M6 2a1 1 0 00-1 1v1H4a2 2 0 00-2 2v10a2 2 0 002 2h12a2 2 0 002-2V6a2 2 0 00-2-2h-1V3a1 1 0 10-2 0v1H7V3a1 1 0 00-1-1zm0 5a1 1 0 000 2h8a1 1 0 100-2H6z" clipRule="evenodd" />
                  </svg>
                  {formatDate(t("usefullInfo.blog_7.date_published"))}
                </span>
                <span className="flex items-center">
                  <svg xmlns="http://www.w3.org/2000/svg" className="h-3 w-3 sm:h-4 sm:w-4 mr-1" viewBox="0 0 20 20" fill="currentColor">
              ...
              <div className="prose prose-lg prose-teal max-w-none">
                ...
                <div className="bg-white rounded-lg sm:rounded-xl shadow-sm border border-slate-200 p-4 sm:p-6 md:p-8 mb-6 sm:mb-8">
                  <h2 className="text-lg sm:text-xl md:text-2xl font-bold text-slate-800 mb-3 sm:mb-5" id="section-1">
                    {t("usefullInfo.blog_7.sections.0.title")}
                  </h2>
                  <p className="text-sm sm:text-base text-slate-700 leading-relaxed">{t("usefullInfo.blog_7.sections.0.content")}</p>
                </div>
                
                {/* Section 2 */}
                <div className="bg-white rounded-lg sm:rounded-xl shadow-sm border border-slate-200 p-4 sm:p-6 md:p-8 mb-6 sm:mb-8">
                  <h2 className="text-lg sm:text-xl md:text-2xl font-bold text-slate-800 mb-3 sm:mb-5" id="section-2">
                    {t("usefullInfo.blog_7.sections.1.title")}
                  </h2>
                  <p className="text-sm sm:text-base text-slate-700 leading-relaxed">{t("usefullInfo.blog_7.sections.1.content")}</p>
                </div>
                
                {/* Section 3 */}
                <div className="bg-white rounded-lg sm:rounded-xl shadow-sm border border-slate-200 p-4 sm:p-6 md:p-8 mb-6 sm:mb-8">
                  <h2 className="text-lg sm:text-xl md:text-2xl font-bold text-slate-800 mb-3 sm:mb-5" id="section-3">
                    {t("usefullInfo.blog_7.sections.2.title")}
                  </h2>
                  <p className="mb-4 sm:mb-5 text-sm sm:text-base text-slate-700 leading-relaxed">{t("usefullInfo.blog_7.sections.2.content")}</p>
                  
                  <div className="space-y-4 sm:space-y-6">
                    {[0, 1, 2, 3, 4, 5].map((index) => (
                      <div key={index} className="bg-teal-50 p-3 sm:p-4 rounded-lg border border-teal-100">
                        <h3 className="font-medium text-base sm:text-lg text-slate-800 mb-2">{t(`usefullInfo.blog_7.sections.2.remedies.${index}.name`)}</h3>
                        <p className="text-sm sm:text-base text-slate-700">{t(`usefullInfo.blog_7.sections.2.remedies.${index}.description`)}</p>
                      </div>
                    ))}
                  </div>
                </div>
                ...
                <div className="bg-white rounded-lg sm:rounded-xl shadow-sm border border-slate-200 p-4 sm:p-6 md:p-8 mb-6 sm:mb-8">
                  <h2 className="text-lg sm:text-xl md:text-2xl font-bold text-slate-800 mb-3 sm:mb-5" id="section-4">
                    {t("usefullInfo.blog_7.sections.3.title")}
                  </h2>
                  <p className="mb-4 sm:mb-5 text-sm sm:text-base text-slate-700 leading-relaxed">{t("usefullInfo.blog_7.sections.3.content")}</p>
                  
                  <div className="bg-yellow-50 border-l-4 border-yellow-400 p-3 sm:p-4 rounded-r-lg">
                    <p className="text-sm sm:text-base text-slate-700 mb-0">{t("usefullInfo.blog_7.sections.3.recommendation")}</p>
                  </div>
                </div>
                ...
                <div className="bg-white rounded-lg sm:rounded-xl shadow-sm border border-slate-200 p-4 sm:p-6 md:p-8 mb-6 sm:mb-8" id="section-5">
                  <h2 className="text-lg sm:text-xl md:text-2xl font-bold text-slate-800 mb-3 sm:mb-5">
                    {t("usefullInfo.blog_7.conclusion.title")}
                  </h2>
                  <p className="mb-4 sm:mb-5 text-sm sm:text-base text-slate-700 leading-relaxed">{t("usefullInfo.blog_7.conclusion.content")}</p>
                  
                  <div className="bg-teal-50 border-l-4 border-teal-500 p-3 sm:p-4 rounded-r-lg">
                    <p className="text-sm sm:text-base text-slate-700 italic mb-0">{t("usefullInfo.blog_7.conclusion.note")}</p>
                  </div>
                </div>
              </div>
            </div>
              ...
              <div className="sticky top-24 space-y-4 sm:space-y-6 lg:space-y-8">
                ...
                <div className="bg-white rounded-lg sm:rounded-xl shadow-sm border border-slate-200 p-4 sm:p-6">
                  <div className="flex items-center mb-3 sm:mb-4">
                    <div className="w-12 h-12 sm:w-16 sm:h-16 bg-teal-100 rounded-full flex items-center justify-center text-teal-700 font-bold text-lg sm:text-xl mr-3 sm:mr-4 flex-shrink-0">
                      {t("usefullInfo.blog_7.author").split(' ').map(name => name[0]).join('')}
                    </div>
                    <div>
                      <h3 className="text-base sm:text-lg font-bold text-slate-800">{t("usefullInfo.blog_7.author")}</h3>
                ...
                <div className="bg-white rounded-lg sm:rounded-xl shadow-sm border border-slate-200 p-4 sm:p-6">
                  ...
                  <div className="flex flex-wrap gap-1.5 sm:gap-2">
                    {t("usefullInfo.blog_7.seo.keywords", { returnObjects: true }).map((keyword, index) => (
