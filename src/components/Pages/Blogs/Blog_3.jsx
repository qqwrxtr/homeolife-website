  ...
  return (
    ...
    >
            ...
            <div className="w-full max-w-[90vw] mx-auto">
              ...
              <div className="flex flex-wrap items-center gap-2 sm:gap-4 text-xs sm:text-sm text-white/90 mb-2 sm:mb-4">
                <span className="flex items-center">
                  ...
                  {t("usefullInfo.blog_3.author")}
                </span>
                <span className="flex items-center">
                  <svg xmlns="http://www.w3.org/2000/svg" className="h-3 w-3 sm:h-4 sm:w-4 mr-1" viewBox="0 0 20 20" fill="currentColor">
                    <path fillRule="evenodd" d="M6 2a1 1 0 00-1 1v1H4a2 2 0 00-2 2v10a2 2 0 002 2h12a2 2 0 002-2V6a2 2 0 00-2-2h-1V3a1 1 0 10-2 0v1H7V3a1 1 0 00-1-1zm0 5a1 1 0 000 2h8a1 1 0 100-2H6z" clipRule="evenodd" />
                  </svg>
                  {formatDate(t("usefullInfo.blog_3.date_published"))}
                </span>
                <span className="flex items-center">
                  <svg xmlns="http://www.w3.org/2000/svg" className="h-3 w-3 sm:h-4 sm:w-4 mr-1" viewBox="0 0 20 20" fill="currentColor">
      ...
      <section className="py-6 sm:py-8 md:py-12 lg:py-16 bg-white">
        <div className="w-full max-w-[90vw] lg:max-w-[85vw] xl:max-w-[80vw] mx-auto px-4 sm:px-6 lg:px-8">
              ...
              <div className="prose prose-lg prose-teal max-w-none">
                ...
                <div className="bg-white rounded-lg sm:rounded-xl shadow-sm border border-slate-200 p-4 sm:p-6 md:p-8 mb-6 sm:mb-8">
                  <h2 className="text-lg sm:text-xl md:text-2xl font-bold text-slate-800 mb-3 sm:mb-5" id="section-1">
                    {t("usefullInfo.blog_3.sections.0.title")}
                  </h2>
                  <p className="text-sm sm:text-base text-slate-700 leading-relaxed">{t("usefullInfo.blog_3.sections.0.content")}</p>
                </div>
                
                {/* Section 2 */}
                <div className="bg-white rounded-lg sm:rounded-xl shadow-sm border border-slate-200 p-4 sm:p-6 md:p-8 mb-6 sm:mb-8">
                  <h2 className="text-lg sm:text-xl md:text-2xl font-bold text-slate-800 mb-3 sm:mb-5" id="section-2">
                    {t("usefullInfo.blog_3.sections.1.title")}
                  </h2>
                    ...
                    <ul className="space-y-2 sm:space-y-3">
                      {[0, 1, 2, 3].map((index) => (
                        <li key={index} className="flex items-start">
                          ...
                          <span className="text-sm sm:text-base text-slate-700">{t(`usefullInfo.blog_3.sections.1.list.${index}`)}</span>
                        </li>
                      ))}
                    </ul>
                  </div>
                  ...
                  <div className="bg-yellow-50 border-l-4 border-yellow-400 p-3 sm:p-4 rounded-r-lg">
                    <p className="italic text-sm sm:text-base text-slate-700 mb-0">{t("usefullInfo.blog_3.sections.1.note")}</p>
                  </div>
                </div>
                ...
                <div className="bg-white rounded-lg sm:rounded-xl shadow-sm border border-slate-200 p-4 sm:p-6 md:p-8 mb-6 sm:mb-8">
                  <h2 className="text-lg sm:text-xl md:text-2xl font-bold text-slate-800 mb-3 sm:mb-5" id="section-3">
                    {t("usefullInfo.blog_3.sections.2.title")}
                  </h2>
                  <p className="mb-4 sm:mb-5 text-sm sm:text-base text-slate-700 leading-relaxed">{t("usefullInfo.blog_3.sections.2.content")}</p>
                  
                  <div className="space-y-2 sm:space-y-3 mb-4 sm:mb-5">
                    {[0, 1, 2, 3, 4, 5].map((index) => (
                      <div key={index} className="flex items-start bg-slate-50 p-2 sm:p-3 rounded-lg border border-slate-200">
                        <div className="w-6 h-6 bg-teal-500 rounded-full text-white flex items-center justify-center font-semibold text-sm mr-3 flex-shrink-0">
                          {index + 1}
                        </div>
                        <span className="text-sm sm:text-base text-slate-700">{t(`usefullInfo.blog_3.sections.2.steps.${index}`)}</span>
                      </div>
                    ))}
                  </div>
                  
                  <div className="bg-teal-50 border-l-4 border-teal-500 p-3 sm:p-4 rounded-r-lg">
                    <p className="text-sm sm:text-base text-slate-700 mb-0 font-medium">{t("usefullInfo.blog_3.sections.2.important")}</p>
                  </div>
                </div>
                ...
                <div className="bg-white rounded-lg sm:rounded-xl shadow-sm border border-slate-200 p-4 sm:p-6 md:p-8 mb-6 sm:mb-8">
                  <h2 className="text-lg sm:text-xl md:text-2xl font-bold text-slate-800 mb-3 sm:mb-5" id="section-4">
                    {t("usefullInfo.blog_3.sections.3.title")}
                  </h2>
                  <p className="mb-4 sm:mb-5 text-sm sm:text-base text-slate-700 leading-relaxed">{t("usefullInfo.blog_3.sections.3.content")}</p>
                  
                  <div className="grid grid-cols-1 sm:grid-cols-3 gap-3 sm:gap-4 mb-4 sm:mb-5">
                    {[0, 1, 2].map((index) => (
                      <div key={index} className="bg-slate-50 p-3 sm:p-4 rounded-lg border border-slate-200 text-center">
                        <p className="text-sm sm:text-base text-slate-700 mb-0 font-medium">{t(`usefullInfo.blog_3.sections.3.examples.${index}`)}</p>
                      </div>
                    ))}
                  </div>
                  
                  <p className="italic text-sm sm:text-base text-slate-700 border-l-4 border-teal-500 pl-3 sm:pl-4 py-1 sm:py-2">{t("usefullInfo.blog_3.sections.3.conclusion")}</p>
                </div>
                
                {/* Section 5 */}
                <div className="bg-white rounded-lg sm:rounded-xl shadow-sm border border-slate-200 p-4 sm:p-6 md:p-8 mb-6 sm:mb-8">
                  <h2 className="text-lg sm:text-xl md:text-2xl font-bold text-slate-800 mb-3 sm:mb-5" id="section-5">
                    {t("usefullInfo.blog_3.sections.4.title")}
                  </h2>
                  
                  <div className="bg-green-50 p-3 sm:p-5 rounded-lg border border-green-100 mb-0">
                    <ul className="space-y-2 sm:space-y-3">
                      {[0, 1, 2, 3].map((index) => (
                        <li key={index} className="flex items-start">
                          ...
                          <span className="text-sm sm:text-base text-slate-700">{t(`usefullInfo.blog_3.sections.4.list.${index}`)}</span>
                        </li>
                      ))}
                    </ul>
                  </div>
                ...
                <div className="bg-white rounded-lg sm:rounded-xl shadow-sm border border-slate-200 p-4 sm:p-6 md:p-8 mb-6 sm:mb-8">
                  <h2 className="text-lg sm:text-xl md:text-2xl font-bold text-slate-800 mb-3 sm:mb-5" id="section-6">
                    {t("usefullInfo.blog_3.sections.5.title")}
                  </h2>
                  <p className="mb-4 sm:mb-5 text-sm sm:text-base text-slate-700 leading-relaxed">{t("usefullInfo.blog_3.sections.5.content")}</p>
                  
                  <div className="space-y-2 sm:space-y-3">
                    {[0, 1, 2].map((index) => (
                      <div key={index} className="flex items-start bg-teal-50 p-3 sm:p-4 rounded-lg border border-teal-100">
                        <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 text-teal-500 mr-2 sm:mr-3 mt-0.5 flex-shrink-0" viewBox="0 0 20 20" fill="currentColor">
                          <path fillRule="evenodd" d="M6.267 3.455a3.066 3.066 0 001.745-.723 3.066 3.066 0 013.976 0 3.066 3.066 0 001.745.723 3.066 3.066 0 012.812 2.812c.051.643.304 1.254.723 1.745a3.066 3.066 0 010 3.976 3.066 3.066 0 00-.723 1.745 3.066 3.066 0 01-2.812 2.812 3.066 3.066 0 00-1.745.723 3.066 3.066 0 01-3.976 0 3.066 3.066 0 00-1.745-.723 3.066 3.066 0 01-2.812-2.812 3.066 3.066 0 00-.723-1.745 3.066 3.066 0 010-3.976 3.066 3.066 0 00.723-1.745 3.066 3.066 0 012.812-2.812zm7.44 5.252a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clipRule="evenodd" />
                        </svg>
                        <span className="text-sm sm:text-base text-slate-700">{t(`usefullInfo.blog_3.sections.5.benefits.${index}`)}</span>
                      </div>
                    ))}
                  </div>
                </div>
                ...
                <div className="bg-teal-50 border-2 border-teal-100 p-4 sm:p-6 md:p-8 rounded-lg sm:rounded-xl mb-6 sm:mb-8 relative mt-12 sm:mt-16">
                  ...
                  <h3 className="text-base sm:text-lg md:text-xl font-bold text-slate-800 text-center mb-3 sm:mb-4 mt-2 sm:mt-4">{t("usefullInfo.blog_3.cta.question")}</h3>
                  <p className="text-sm sm:text-base text-center text-slate-700 mb-4 sm:mb-6">{t("usefullInfo.blog_3.cta.content")}</p>
                  <div className="text-center">
                    ...
                    >
                      {t("usefullInfo.blog_3.cta.button_text")}
              ...
              <div className="sticky top-24 space-y-4 sm:space-y-6 lg:space-y-8">
                ...
                <div className="bg-white rounded-lg sm:rounded-xl shadow-sm border border-slate-200 p-4 sm:p-6">
                  <div className="flex items-center mb-3 sm:mb-4">
                    <div className="w-12 h-12 sm:w-16 sm:h-16 bg-teal-100 rounded-full flex items-center justify-center text-teal-700 font-bold text-lg sm:text-xl mr-3 sm:mr-4 flex-shrink-0">
                      {t("usefullInfo.blog_3.author").split(' ').map(name => name[0]).join('')}
                    </div>
                    <div>
                      <h3 className="text-base sm:text-lg font-bold text-slate-800">{t("usefullInfo.blog_3.author")}</h3>
                        ...
                        <li key={index} className="border-b border-slate-100 pb-1 sm:pb-2 last:border-0 last:pb-0">
                          ...
                          >
                            ...
                            <span className="line-clamp-1">
                              {t(`usefullInfo.blog_3.sections.${index}.title`)}
                            </span>
                          </a>
                        </li>
                      ))}
                ...
                <div className="bg-white rounded-lg sm:rounded-xl shadow-sm border border-slate-200 p-4 sm:p-6">
                  ...
                  <div className="flex flex-wrap gap-1.5 sm:gap-2">
                    {t("usefullInfo.blog_3.seo.keywords", { returnObjects: true }).map((keyword, index) => (
