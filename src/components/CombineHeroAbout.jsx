  ...
  return (
    <>
      ...
      <div className="relative w-full h-screen max-h-[800px] min-h-[500px] 2xl:min-h-[600px] overflow-hidden">
        {/* Video Container - Fixed position but clipped by parent overflow:hidden */}
        <div className="absolute inset-0 w-full h-full">
          {/* Professional overlay with subdued gradient */}
          <div className="absolute inset-0 bg-gradient-to-b from-slate-900/10 via-slate-800/60 to-slate-900/25 z-10"></div>
          <video 
      ...
      <section 
        ref={aboutSectionRef}
        className="relative py-16 md:py-24 bg-gradient-to-b from-slate-50 to-white w-full z-10"
      >
        <div className="container mx-auto px-4 sm:px-6">
          <div className="flex flex-col lg:flex-row items-center lg:items-start gap-12 lg:gap-16">
            ...
            <div className="lg:w-2/5 relative">
              <div 
                className={`relative transition-all duration-1000 ${isAboutVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`}
              ...
              <div className="mt-8 space-y-4">
                <div 
                  className={`bg-white p-5 rounded-lg shadow-md transform transition-all duration-500 hover:shadow-lg hover:-translate-y-1 border-l-4 border-teal-500 ${isAboutVisible ? 'opacity-100 translate-x-0' : 'opacity-0 -translate-x-8'}`}
            ...
            {/* Text Column */}
            <div 
              className={`lg:w-3/5 ${isAboutVisible ? 'animate-slideInRight' : 'opacity-0 translate-x-10'}`}
              style={{ 
                animationDelay: '0.3s', 
